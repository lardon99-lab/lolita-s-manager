        ...
        window.Swal.fire = function (...args) {
            if (typeof args[0] === 'object' && args[0] !== null) {
                ...
                args[0] = {
                    ...
                    customClass: {
                        ...customClass,
                        popup: `app-dialog ${customClass.popup || ''}`.trim(),
                        title: `app-dialog__title ${customClass.title || ''}`.trim(),
                        htmlContainer: `app-dialog__body ${customClass.htmlContainer || ''}`.trim(),
                        actions: `app-dialog__actions ${customClass.actions || ''}`.trim(),
