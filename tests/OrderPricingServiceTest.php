...
final class OrderPricingServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->db->exec("CREATE TABLE productos (id_producto INTEGER PRIMARY KEY, precio_base NUMERIC, estado TEXT)");
        ...
        $this->db->exec("INSERT INTO productos VALUES (1, 365, 'Activo'), (2, 220, 'Activo')");
